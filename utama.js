...
// Apis 
const API_KEY = "0f19e97cd8384f20a0ece00a983f8e81";
...
window.onload = function() {
    newsType.innerHTML="<h4>Berita AlNews</h4>";
    fetchHeadlines();
};

generalBtn.addEventListener("click",function(){
    newsType.innerHTML="<h4>Berita Umum</h4>";
    fetchGeneralNews();
});
...
sportsBtn.addEventListener("click",function(){
    newsType.innerHTML="<h4>Olahraga</h4>";
    fetchSportsNews();
});

entertainmentBtn.addEventListener("click",function(){
    newsType.innerHTML="<h4>Hiburan</h4>";
